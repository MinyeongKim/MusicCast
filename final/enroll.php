	...
	<body>
         	...
         	<div id = "main2">
            		<center><table>
               			...
               			<tr>
                  			<td>
                     				<input type="radio" name="prefer" checked value = "fear">Fear <!--공포-->
                     				<input type="radio" name="prefer" value = "cheer">cheer <!--응원-->
                     				<input type="radio" name="prefer" value = "drowsy">Drowsy <!--나른-->
                     				<input type="radio" name="prefer" value = "dear">Dear <!--애틋-->
                     				<br>
                     				<input type="radio" name="prefer" value = "dreamlike">Dreamlike <!--몽환-->
                     				<input type="radio" name="prefer" value = "pleasant">Pleasant <!--신남/즐거운-->
                     				<input type="radio" name="prefer" value = "magnificent">Magnificent <!--웅장-->
                     				<br>
                     				<input type="radio" name="prefer" value = "sad">Sad <!--슬픔-->
                     				<input type="radio" name="prefer" value = "thrill">Thrill <!--설렘-->
                     				<input type="radio" name="prefer" value = "anger">Anger <!--분노-->
                     				<input type="radio" name="prefer" value = "quiet">Quiet <!--잔잔-->
                     				<input type="radio" name="prefer" value = "lonely">Lonely <!--쓸쓸-->
                  			</td>   
               			</tr> 
            		</table>
         	</div>
