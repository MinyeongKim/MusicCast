   ...
   <body>
      ...
      <div id = "login">
         <form method = "post" action = "login_access.php">
            <center><table>
               <tr>
                     <td>&nbsp;&nbsp;&nbsp;E-MAIL :&nbsp;&nbsp;&nbsp;<input class="id" name = "user_email" type="text" onfocus="this.className='id_focus'" onblur="if(this.value.length==0) {this.className='id'}"/></td>
               </tr>
               <tr></tr><tr></tr><tr></tr>
               <tr>
                     <td> PASSWORD : <input class="pw" name = "user_pw" type="password" onfocus="this.className='pw_focus'" onblur="if(this.value.length==0){this.className='pw'}"/></td>
               </tr>
            </table>
         </form>
